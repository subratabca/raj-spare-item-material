        ...
        <div class="flex-grow-1 mt-3 mt-sm-5">
          <div
            ...
            <div class="user-profile-info">
              <h4 id="user-firstName">Client Name</h4>
              <ul
  ...
  async function getProfile(){
    try {
      ...
      if(res.status === 200 && res.data['status']==='success'){
        ...
        document.getElementById('commonImg').src = data['image'] ? "/upload/client-profile/small/" + data['image'] : "/upload/no_image.jpg";
        ...
        if (window.location.href === "http://127.0.0.1:8000/client/update/profile") {
