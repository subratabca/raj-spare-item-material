          ...
          <div class="row">
            ...
            <div class="col-md-12 p-4">
              <div class="form-check">
                ...
                <label class="form-check-label" for="defaultCheck3"><a href="/client/terms-conditions/food_upload" target="_blank">Accept T&C For Food Upload</a></span><span class="text-danger">*</span></label>
              </div>
...
function resetCreateForm() {
  ...
  async function Save() {
    ...
    if (name.length === 0) {
      ...
      try {
        let res = await axios.post("/client/store/food", formData, config);
        if (res.status === 201) {
