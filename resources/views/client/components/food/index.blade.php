<div class="card">
    <div class="card-header header-elements">
        ...
        <div class="card-header-elements ms-auto">
            <a href="/client/create/food" type="button" class="btn btn-primary waves-effect waves-light">
            ...
            if (res.data.data.length === 0) {
                ...
                res.data.data.forEach(function (item, index) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a  href="/client/food/details/${item['id']}" class="btn btn-sm btn-outline-primary"><span class="mdi mdi-eye-circle"></span>
                            </a>

                            <a href="/client/edit/food/${item['id']}" class="btn btn-sm btn-outline-success"><span class="mdi mdi-pencil-outline"></span>
                            </a>

                            <a href="/client/edit/food/multi-image/${item['id']}" class="btn btn-sm btn-outline-info"><span class="mdi mdi-image-edit-outline"></span>
                            </a>
