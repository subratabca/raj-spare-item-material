          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <span class="error-message text-danger" id="name-error"></span> <!-- Error outside the select -->
              </div>
            </div>
        ...
        if (error.response && error.response.status === 422) {
            ...
            for (let field in errorMessages) {
                ...
                if (fieldErrorElement) {
                    fieldErrorElement.innerText = errorMessages[field][0];  // Display server error
                }
            }
