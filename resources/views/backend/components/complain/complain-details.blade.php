            ...
            <div class="card-body">
                <div class="info-container">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="button" onclick="complainSend()" id="send-complain-footer" class="btn btn-primary me-3">Send to client</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    async function ComplainDetailsInfo() {
        ...
        try {
            ...
            document.getElementById('send-complain-footer').disabled = status !== 'pending';
