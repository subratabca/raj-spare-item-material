      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
          <img
            src="{{ asset('frontend/assets/img/illustrations/auth-forgot-password-illustration-light.png') }}"
            class="auth-cover-illustration w-100"
            alt="auth-illustration"
            data-app-light-img="{{ asset('frontend/assets/img/illustrations/auth-forgot-password-illustration-light.png') }}"
            data-app-dark-img="{{ asset('frontend/assets/img/illustrations/auth-forgot-password-illustration-dark.png') }}" />

          <img
            src="{{ asset('frontend/assets/img/illustrations/auth-cover-forgot-password-mask-light.png') }}"
            class="authentication-image"
            alt="mask"
            data-app-light-img="{{ asset('frontend/assets/img/illustrations/auth-cover-forgot-password-mask-light.png') }}"
            data-app-dark-img="{{ asset('frontend/assets/img/illustrations/auth-cover-forgot-password-mask-dark.png') }}" />
        </div>
        <!-- /Left Section -->
